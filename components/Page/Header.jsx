    ...
    return (
        <header>
            <SideBar>
                ...
                <div className = 'container px-4'>
                    <div className = 'user-select-0 row py-4 px-3 j-c-space-between a-i-c'>
                        ...
                        <div className = ''>
                            ...
                            <div className="d-inline-block px-4 po-rel">
                                ...
                                <div className = {`po-abs top-150pcent right-0 bg-white z-index-1000 animated fadeIn rounded shadow vw80 max-width-300px p-3 ttt-more`}>
                                    <div>{(
                                        (cart.length > 0)
                                        ? cart.map(
                                            ({name, price, quantity, image, id}, key) => (
                                                <div key = {key} className="flex-h border-bottom a-i-c px-3 py-4">
                                                    <div className = 'mr-3 flex-1'>
                                                        <div className = 'double-line text-capitalize text-dark'>
                                                            {name}
                                                        </div>
                                                        <div className = 'm-0 text-muted'>{quantity} x {currency}{new Intl.NumberFormat().format(price)}</div>
                                                    </div>
                                                    <div>
                                                        <div className = 'border flex-v j-c-c bg-light overflow-0' style = {{width: '50px', height: '50px'}}>
