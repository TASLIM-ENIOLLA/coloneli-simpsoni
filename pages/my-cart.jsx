...
const CartRow = ({id, name, price, quantity, image, updateCart}) => {
    ...
    useEffect(async () => {
        const req = await fetch(`${API_ROUTE.is_product_exist}?productID=${id}`)
    ...
    return (
        <tr className = {`${isExisting ? '' : 'border-left-thick-danger'}`} title = {!isExisting ? 'This product seems to have been removed from the store and hence you can\'t purchase it!' : undefined}>
            <td className = {isExisting ? '' : 'opacity-5'}>
                <div className="container">
                    <div className="row a-i-c py-2">
                        <div className="col-auto p-0">
                            <div className = 'border bg-light flex-v a-i-c j-c-c overflow-0' style = {{width: '70px', height: '70px'}}>
            ...
            <td className = {isExisting ? '' : 'opacity-5 pointer-events-0'}>
                <div className="container">
                    <div className="row a-i-c mx-auto" style = {{width: '70px', height: '70px'}}>
                        <div className="col-12">
...
const CartBlock = ({id, name, price, quantity, image, updateCart}) => {
    ...
    return (
        <div title = {!isExisting ? 'This product seems to have been removed from the store and hence you can\'t purchase it!' : undefined} className={`${isExisting ? '' : 'border-top-thick-danger'} flex-h rounded border mb-4 po-rel pt-4`}>
            ...
            <div className = {`${isExisting ? '' : 'opacity-5'} mx-auto text-c p-4 col-auto`}>
                <div className="row a-i-c py-2">
                    <div className="col-auto p-0">
                        <div className = 'border bg-light flex-v a-i-c j-c-c overflow-0' style = {{width: '70px', height: '70px'}}>
                            <img src={image} className="d-block w-100"/>
                ...
                <div className = {isExisting ? '' : 'py-3 pointer-events-0'}>
                    <NumberInput onChange = {(newQuantity) => {
                        setTotal(newQuantity * price)
                        localCartUpdater({
                            ...localCart,
            ...
            <style jsx>{`
                .border-top-thick-danger{
                    border-top: 10px solid #ff9191 !important;
                }
            `}</style>
        </div>
    )
...
const OrderList = ({name, quantity, id, price}) => {
    ...
    return (
        <div title = {!isExisting ? 'This product seems to have been removed from the store and hence you can\'t purchase it!' : undefined} className = {`${(isExisting === true || isExisting === undefined) ? '' : 'strike-through'} flex-h j-c-space-between text-muted py-4 border-bottom mb-3`}>
        ...
        <>
            <div className = 'border rounded bg-light p-4'>
                ...
                <div className = 'py-4'>
                    ...
                    <div className = 'flex-h bold text-muted letter-spacing-1 j-c-space-between a-i-c py-4'>
