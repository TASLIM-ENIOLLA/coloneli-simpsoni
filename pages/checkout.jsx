                                ...
                                <div className = 'py-4'>
                                    <div>
                                        ...
                                        <div>{(
                                            ...
                                            : (
                                                <div className = 'p-5 text-center'>You cart is empty. Go to <a href="/shop" className = ''>shop</a> to add products to your cart</div>
                                            )
                                        )}</div>
                                        <div className = 'flex-h j-c-space-between bold letter-spacing-1 text-muted a-i-c py-4'>
                                            <div className = 'flex-h px-3'>
                                            ...
                                            <div className = 'flex-h px-3'>
                                                {currency}{new Intl.NumberFormat().format(Object.values(cart).map(
