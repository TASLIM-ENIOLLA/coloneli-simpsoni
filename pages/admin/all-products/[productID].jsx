                        ...
                        <div className="row pt-3">
                            ...
                            <div className="col-12 col-md-6 px-0 px-md-2 mb-5">
                                <div className="bg-white p-3 rounded-1x border">
                                    ...
                                    <div className = 'pt-2 pb-2 d-block w-100 text-muted'>{currency}{new Intl.NumberFormat().format(productsData?.price)}</div>
                                </div>
                            </div>
                            <div className="col-12 col-md-6 px-0 px-md-2 mb-5">
                                <div className="bg-white p-3 rounded-1x border">
                            ...
                            <div className="col-12 col-md-6 px-0 px-md-2 mb-5">
                                <div className="bg-white p-3 rounded-1x border">
                                    <p className = 'text-capitalize mb-2 text-dark bold letter-spacing-1'>Gender</p>
                                    <div className = 'pt-2 pb-2 d-block w-100 text-muted text-capitalize'>{productsData?.gender}</div>
                                </div>
                            </div>
                            <div className="col-12 col-md-6 px-0 px-md-2 mb-5">
                                <div className="bg-white p-3 rounded-1x border">
