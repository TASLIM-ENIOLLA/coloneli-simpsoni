...
export default () => {
    ...
    return (
        <AdminPageTemplate>
            <div className="py-5">
                <a href = '/admin/add-product' className="p-4 theme-bg border-0 text-white bold letter-spacing-1 rounded-1x shadow text-capitalize d-inline-block">add new product</a>
            </div>
            <div>
                <div className = "row mb-3">
                    ...
                    <div className = "col-xs-12 col-lg-3 mb-3">
                        ...
                        <div style = {{minHeight: '50px'}} className = "p-1 mb-2 flex-1 overflow-0 rounded-1x bg-white flex-h a-i-c shadow-sm">
                            <select value = {tableStates.gender} onChange = {(e) => setTableStates({...tableStates, gender: e.target.value})} className = "d-inline-block border-0 p-3 w-100 text-capitalize outline-0">
                                <option value = "">all</option>
            ...
            <div className="table-responsive border rounded-1x mt-5">
                <table className="table table-striped table-hover m-0 text-c">
                    ...
                    <tbody>{(
                        ...
                        ? (
                            productsList.map(({id, name, category, sold, gender, price, quantity, timestamp}, index) => (
