                ...
                <form onSubmit = {(e) => {
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-12 mb-5">
                            ...
                            <select value = {formData?.gender} onChange = {(e) => (setIsUpdated(true), setFormData({...formData, gender: e.target.value}))} className = 'p-4 d-block text-capitalize w-100 outline-0 border rounded'>
