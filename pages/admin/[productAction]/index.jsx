            ...
            <form onSubmit = {(e) => {
                ...
                <div className="row">
                    <div className="col-md-6 mb-5">
                        ...
                        <input value = {CapFirstLetter(formData.name)} onChange = {(e) => setFormData({...formData, name: e.target.value})} type="text" className = 'p-4 d-block w-100 border rounded' />
                    </div>
                    <div className="col-md-6 mb-5">
                        <p className = 'text-capitalize mb-2'>Product category *</p>
                        <select value = {formData.category} onChange = {(e) => setFormData({...formData, category: e.target.value})} className = 'p-4 d-block text-capitalize w-100 border rounded'>
                    ...
                    <div className="col-md-6 mb-5">
                        ...
                        <NumberInput value = {new Intl.NumberFormat().format(formData.quantity)} onChange = {(e) => setFormData({...formData, quantity: e.target.value.replace(/\,/g, '')})} className = 'p-4 d-block w-100 border rounded' />
                    </div>
                    <div className="col-md-6 mb-5">
                        <p className = 'text-capitalize mb-2'>Product price ({currency}) *</p>
                        <NumberInput value = {new Intl.NumberFormat().format(formData.price)} onChange = {(e) => setFormData({...formData, price: e.target.value.replace(/\,/g, '')})} className = 'p-4 d-block w-100 border rounded' />
                    </div>
                    <div className="col-md-12 mb-5">
                        <p className = 'text-capitalize mb-2'>Sex *</p>
                        <select value = {formData.gender} onChange = {(e) => setFormData({...formData, gender: e.target.value})} className = 'p-4 d-block text-capitalize w-100 border rounded'>
                    ...
                    <div className="col-md-12 mb-5">
                        ...
                        <textarea value = {CapFirstLetter(formData.description)} onChange = {(e) => setFormData({...formData, description: e.target.value})} rows = "5" className = 'p-4 resize-0 d-block w-100 border rounded' placeholder = 'Enter product description...'></textarea>
                    </div>
                    <div className="col-md-12 mb-5">
...
export async function getServerSideProps(context){
    const {req: {cookies}, resolvedUrl, params: {productAction}} = context
