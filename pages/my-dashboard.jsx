...
const Orders = () => {
    const {globalStates: {isLoggedIn: {state: isLoggedIn}, userData: {state: {id}}}} = useContext(GlobalContext)
            ...
            <div className = 'table-responsive border rounded-1x mb-4'>
                <table className="table table-hover text-center m-0">
                    ...
                    <tbody>{
                        ...
                        ? (
                            Object.values(customerOrders).map(
                                (order, key) => (
                        ...
                        : (
                            <tr>
                                <td colSpan = '4'>
                                    <p className="p-5 bold letter-spacing-1 text-c">
...
export async function getServerSideProps(context){
    ...
    if(!cookie || !JSON.parse(cookie).id){
        return {
            redirect: {
                destination: '/'
            }
