...
import TopRibbon from '../components/Page/TopRibbon'
            ...
            <section className = 'py-5'>
                <div className="p-5">
                    ...
                    <div className = 'text-center pt-3'>
                        <div className = 'px-3 py-2 text-capitalize rounded bg-warning d-inline-block cursor-pointer mx-3 text-white mb-3'>all</div>
                        <div className = 'px-3 py-2 text-capitalize rounded bg-warning d-inline-block cursor-pointer mx-3 text-white mb-3'>men</div>
                        <div className = 'px-3 py-2 text-capitalize rounded bg-warning d-inline-block cursor-pointer mx-3 text-white mb-3'>women</div>
                        <div className = 'px-3 py-2 text-capitalize rounded bg-warning d-inline-block cursor-pointer mx-3 text-white mb-3'>shoes</div>
                        <div className = 'px-3 py-2 text-capitalize rounded bg-warning d-inline-block cursor-pointer mx-3 text-white mb-3'>accessories</div>
                    </div>
                </div>
                <div className="container py-4">
                    <div className="row">
